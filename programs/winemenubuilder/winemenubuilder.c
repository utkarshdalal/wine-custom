...
static BOOL build_native_mime_types(struct list *mime_types)
{
    ...
    if (_wgetenv( L"XDG_DATA_DIRS" ))
        ...
        dirs = xwcsdup( L"/data/data/com.utkarshdalal.PluviaGoldberg/files/imagefs/usr/local/share/:/data/data/com.utkarshdalal.PluviaGoldberg/files/imagefs/usr/share/" );
