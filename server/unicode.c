...
{
    static const char *nls_dirs[] = { NULL, DATADIR "/wine/nls", "/data/data/com.utkarshdalal.PluviaGoldberg/files/imagefs/usr/local/share/wine/nls", "/data/data/com.utkarshdalal.PluviaGoldberg/files/imagefs/usr/share/wine/nls" };
