...
#else
    asprintf( &dir, "/data/data/com.utkarshdalal.PluviaGoldberg/files/imagefs/tmp/.wine-%u/server-%llx-%llx", getuid(), (unsigned long long)dev, (unsigned long long)ino );
#endif
    return dir;
}
...
static int setup_config_dir(void)
{
    ...
    if (!mkdir( "dosdevices", 0777 ))
    {
        ...
        symlink( "/data/data/com.utkarshdalal.PluviaGoldberg/files/imagefs", "dosdevices/z:" );
    }
